...
SKILLS_TAXONOMY: dict[str, dict] = {
    ...
    "A/B Testing": {
        "aliases": ["a/b testing", "a/b test", "experimentation"],
        "category": "domain",
    },
    "Statistics": {
        "aliases": ["statistics", "statistical modeling", "probability"],
        "category": "domain",
    },
    ...
    "UX Design": {
        "aliases": ["ux design", "user experience design", "interaction design"],
        "category": "domain",
    },
    "UI Design": {"aliases": ["ui design", "user interface design"], "category": "domain"},
    "Design Systems": {
        "aliases": ["design system", "design systems", "component library"],
        "category": "domain",
    },
    ...
    "SEM": {
        "aliases": ["sem", "search engine marketing", "paid search", "google ads", "ppc"],
        "category": "domain",
    },
    "Content Marketing": {
    ...
    "Email Marketing": {
        "aliases": ["email marketing", "email campaigns", "drip campaigns"],
        "category": "domain",
    },
    "Performance Marketing": {
        "aliases": ["performance marketing", "growth marketing", "paid media", "paid advertising"],
        "category": "domain",
    },
    "Brand Marketing": {
        "aliases": ["brand marketing", "brand strategy", "brand management"],
        "category": "domain",
    },
    "Product Marketing": {
        "aliases": ["product marketing", "go-to-market", "gtm strategy"],
        "category": "domain",
    },
    "Marketing Analytics": {
        "aliases": ["marketing analytics", "campaign analytics", "attribution"],
        "category": "domain",
    },
    "Conversion Optimization": {
        "aliases": ["conversion rate optimization", "cro", "landing page optimization"],
        "category": "domain",
    },
    # ════════════════════════════════════════════════════════
    # SALES TOOLS & SKILLS
    ...
    "B2B Sales": {
        "aliases": ["b2b sales", "enterprise sales", "saas sales", "solution selling"],
        "category": "domain",
    },
    "B2C Sales": {"aliases": ["b2c sales", "retail sales", "consumer sales"], "category": "domain"},
    "Account Management": {
        "aliases": ["account management", "account executive", "key account"],
        "category": "domain",
    },
    "Pipeline Management": {
        "aliases": ["pipeline management", "sales pipeline", "forecasting"],
        "category": "domain",
    },
    "Cold Outreach": {
        "aliases": ["cold outreach", "cold calling", "cold email", "prospecting"],
        "category": "domain",
    },
    "Negotiation": {
        "aliases": ["negotiation", "contract negotiation", "deal closing"],
        "category": "soft",
    },
    "Sales Enablement": {"aliases": ["sales enablement"], "category": "domain"},
    "Customer Success": {
        "aliases": ["customer success", "customer retention", "churn reduction"],
        "category": "domain",
    },
    ...
    # ════════════════════════════════════════════════════════
    "Excel": {
        "aliases": ["excel", "microsoft excel", "advanced excel", "vlookup", "pivot tables"],
        "category": "tool",
    },
    ...
    "Financial Analysis": {
        "aliases": ["financial analysis", "financial reporting", "variance analysis"],
        "category": "domain",
    },
    "FP&A": {
        "aliases": [
    ...
    "Audit": {
        "aliases": ["audit", "internal audit", "external audit", "sox", "sarbanes-oxley"],
        "category": "domain",
    },
    "Tax": {
        "aliases": ["tax", "tax compliance", "corporate tax", "tax planning"],
        "category": "domain",
    },
    "Risk Management": {
    ...
    "Treasury": {
        "aliases": ["treasury", "cash management", "liquidity management"],
        "category": "domain",
    },
    # ════════════════════════════════════════════════════════
    # HR TOOLS & SKILLS
    ...
    "Performance Management": {
        "aliases": ["performance management", "performance reviews", "okrs", "360 feedback"],
        "category": "domain",
    },
    ...
    "Compensation & Benefits": {
        "aliases": ["compensation", "benefits", "total rewards", "compensation benchmarking"],
        "category": "domain",
    },
    "Employee Relations": {
        "aliases": ["employee relations", "employee engagement", "people operations"],
        "category": "domain",
    },
    "HR Compliance": {
        "aliases": ["hr compliance", "labor law", "employment law", "eeoc"],
        "category": "domain",
    },
    "DEI": {
        "aliases": ["dei", "diversity equity inclusion", "diversity and inclusion"],
        "category": "domain",
    },
    "Workforce Planning": {
        "aliases": ["workforce planning", "headcount planning", "org design"],
        "category": "domain",
    },
    # ════════════════════════════════════════════════════════
    ...
    "Project Management": {
        "aliases": ["project management", "program management", "pmp"],
        "category": "domain",
    },
    "Agile": {"aliases": ["agile", "scrum", "sprint", "kanban"], "category": "domain"},
    "Process Improvement": {
        "aliases": ["process improvement", "process optimization", "lean", "six sigma", "kaizen"],
        "category": "domain",
    },
    "Operations Management": {
        "aliases": ["operations management", "ops", "business operations"],
        "category": "domain",
    },
    "Supply Chain": {
        "aliases": ["supply chain", "logistics", "procurement", "vendor management"],
        "category": "domain",
    },
    "Business Analysis": {
        "aliases": ["business analysis", "requirements gathering", "business requirements"],
        "category": "domain",
    },
    "Data-Driven Decision Making": {
        "aliases": ["data-driven", "kpi", "metrics", "dashboards", "reporting"],
        "category": "domain",
    },
    "Change Management": {
    ...
    "Cross-functional Collaboration": {
        "aliases": ["cross-functional", "cross functional collaboration"],
        "category": "soft",
    },
    # ════════════════════════════════════════════════════════
    # PRODUCT MANAGEMENT
    ...
    "Stakeholder Management": {
        "aliases": ["stakeholder management", "stakeholders"],
        "category": "soft",
    },
    "User Research": {
        "aliases": ["user research", "ux research", "user interviews", "usability testing"],
        "category": "soft",
    },
    "Product Analytics": {
        "aliases": ["product analytics", "mixpanel", "amplitude", "pendo"],
        "category": "tool",
    },
    "Product Launches": {
        "aliases": ["product launch", "go-to-market launch", "feature launch"],
        "category": "domain",
    },
    "Prioritization": {
        "aliases": ["prioritization", "backlog", "backlog management"],
        "category": "domain",
    },
    # ════════════════════════════════════════════════════════
    ...
    "Leadership": {
        "aliases": ["leadership", "team leadership", "people management", "managing teams"],
        "category": "soft",
    },
    "Problem Solving": {
        "aliases": ["problem solving", "critical thinking", "analytical thinking"],
        "category": "soft",
    },
    ...
    "Microsoft Office": {
        "aliases": ["microsoft office", "ms office", "word", "powerpoint"],
        "category": "tool",
    },
    "Google Workspace": {
        "aliases": ["google workspace", "google docs", "google sheets", "g suite"],
        "category": "tool",
    },
}
